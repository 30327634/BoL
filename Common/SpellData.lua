return {
	...
	["Malzahar"] = {
		...
		[_W] = { name = "", speed = math.huge, delay = 0.5, range = 800, width = 250, collision = false, aoe = false, type = "circular", dmgAP = function(source, target) return (4+source:GetSpellData(_W).level+source.ap*0.01)*target.maxHealth*0.01 end},
