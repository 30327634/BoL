_G.SmoothEvadeVersion = 0.35
_G.SmoothEvadeInit    = true
...
DelayAction(function()
  if not _G.SmoothEvadeLoaded then
    now = SmoothEvade()
  end
end, 0.25)
...
class "SmoothEvade"
  ...
  function SmoothEvade:__init()
    _G.Evade = false
    ScriptologyConfig:addSubMenu("SmoothEvade", "SmoothEvade")
    self.Config = ScriptologyConfig.SmoothEvade
  ...
  function SmoothEvade:FindSafeSpot(s,p,w,b)
    if Target then
  ...
  function SmoothEvade:DrawRectangleOutline(startPos, endPos, pos, width)
